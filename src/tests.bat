...
echo "##teamcity[testFailed name='comparison-failure' type='comparisonFailure' message='Critical error' expected='package main;|n|nimport org.testng.Assert;|nimport org.testng.annotations.Test;|n|n/**|n * @author Maxim.Manuylov|n *         Date: 3/10/12|n */|n@Test|npublic abstract class BaseTestCase extends Assert {|n    public void test_abstract() {|n        assertEquals(1, 1);|n    }|n|n    public void test_blinking() {|n        assertEquals(System.getProperty(\"qwerty\"), \"123\");|n    }|n}|n' actual='package main;|n|nimport org.testng.Assert;|nimport org.testng.annotations.Test;|n|n/**|n * @author Maxim.Manuylov|n *         Date: 3/10/12|n */|n@Test|npublic abstract class BaseTestCase extends Assert {|n    public void test_abstract() {|n        assertEquals(1, 2);|n    }|n|n    public void test_blinking() {|n        assertEquals(System.getProperty(\"qwerty\"), \"456\");|n    }|n}|n' flowId='0' details='expected: <package main;|n|nimport org.testng.Assert;|nimport org.testng.annotations.Test;|n|n/**|n * @author Maxim.Manuylov|n *         Date: 3/10/12|n */|n@Test|npublic abstract class BaseTestCase extends Assert {|n    public void test_abstract() {|n        assertEquals(1, 1);|n    }|n|n    public void test_blinking() {|n        assertEquals(System.getProperty(\"qwerty\"), \"123\");|n    }|n}|n> but was: <package main;|n|nimport org.testng.Assert;|nimport org.testng.annotations.Test;|n|n/**|n * @author Maxim.Manuylov|n *         Date: 3/10/12|n */|n@Test|npublic abstract class BaseTestCase extends Assert {|n    public void test_abstract() {|n        assertEquals(1, 2);|n    }|n|n    public void test_blinking() {|n        assertEquals(System.getProperty(\"qwerty\"), \"456\");|n    }|n}|n>']"
